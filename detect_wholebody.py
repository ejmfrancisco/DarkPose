...
if __name__ == '__main__':
    ...
    yolo_hub = '/media/tricubics/big/thienpm/openstore_perception_thienpm/data/checkpoints/detector/ultralytics_yolov5_master'
    detector_weight = 'yolov5/weights/yolov5s.pt'
    pose_weight     = '/home/tricubics/eric/SimpleBase_DARK/output/coco/pose_resnet_50/256x192_d256x3_adam_lr1e-3_modify/final_state.pth.tar'
    ...
    pose_cfg_path   = '/home/tricubics/eric/SimpleBase_DARK_inference/experiments/coco/resnet50/256x192_d256x3_adam_lr1e-3_re_edit.yaml'
    img_size = 640
    conf_thres = 0.7
    iou_thres = 0.5
    ...
    while vidcap.isOpened():
        total_now = time.time()
        ret, img_src = vidcap.read()
        count += 1
        if not ret and img_src is None:
            continue
